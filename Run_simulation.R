...
## Sensitivity analysis (different evaluation times)
...
write.csv(out_time, "out_time.csv", row.names = FALSE)
...
write.csv(type1_result, "type1_result.csv", row.names = FALSE)
...
write.csv(power_out, "power_out.csv", row.names = FALSE)
